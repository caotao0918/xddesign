...
layui.define(["layer", "form", "code"], function (t) {
    ...
    s.prototype.set = function (t) {
        ...
        var n = this, l = n.config, o = "layui-layedit", s = i("string" == typeof t ? "#" + t : t),
            ...
            m = i(['<div class="' + o + '">', '<div class="layui-unselect layui-layedit-tool">' + p.replace("layBkColor_Index", "layBkColor_" + n.index).replace("layFontColor_Index", "layFontColor_" + n.index) + "</div>", '<div class="layui-layedit-iframe">', '<iframe  src="empty.html" id="' + c + '" name="' + c + '" textarea="' + t + '" frameborder="0"></iframe>', "</div>", "</div>"].join(""));
    ...
    var r = function (t, e, n) {
        ...
        d.find(">i").on("mousedown", function () {
            ...
            y.call(t, d), n.close(E.index), n.close(T.index), n.close(k.index), n.close(w.index), n.close(_.index)
        });
                ...
                switch (a.tagName) {
                    case "IMG":
                        f = n.open({
                            ...
                            shade: 0,
                            closeBtn: !1,
                            content: ['<ul class="layui-form layui-form-pane" style="margin: 20px 20px 0 20px">', '<li class="layui-form-item" style="position: relative">', '<button type="button" class="layui-btn" id="LayEdit_UpdateImage" style="width: 110px;position: relative;z-index: 10;"> <i class="layui-icon"></i>上传图片</button>', '<input type="text" name="Imgsrc" placeholder="请选择文件" style="position: absolute;width: 100%;padding-left: 120px;left: 0;top:0" value="' + t.target.src + '" class="layui-input">', "</li>", '<li class="layui-form-item" style="position: relative">', '<label class="layui-form-label" style="width: 110px;position: relative;z-index: 10;">描述</label>', '<input type="text" required name="altStr" placeholder="alt属性" style="position: absolute;width: 100%;padding-left: 120px;left: 0;top:0" value="' + t.target.alt + '" class="layui-input">', "</li>", '<li class="layui-form-item" style="position: relative">', '<label class="layui-form-label" style="width: 110px;position: relative;z-index: 10;">宽度</label>', '<input type="text" required name="imgWidth" placeholder="px" style="position: absolute;width: 100%;padding-left: 120px;left: 0;top:0" value="' + ((t.target.style.width.indexOf("%") > 0 ? t.target.style.width : parseInt(t.target.style.width)) || "") + '" class="layui-input">', "</li>", '<li class="layui-form-item" style="position: relative">', '<label class="layui-form-label" style="width: 110px;position: relative;z-index: 10;">高度</label>', '<input type="text" required name="imgHeight" placeholder="px" style="position: absolute;width: 100%;padding-left: 120px;left: 0;top:0" value="' + ((t.target.style.height.indexOf("%") > 0 ? t.target.style.height : parseInt(t.target.style.height)) || "") + '" class="layui-input">', "</li>", "</ul>"].join(""),
        ...
        return t.hide = t.hide || function (e) {
            ...
            success: function (e, l) {
                e.find("td").on("mouseover", function () {
                    ...
                    a && a({cells: this.cellIndex + 1, rows: this.parentElement.rowIndex}), n.close(l)
